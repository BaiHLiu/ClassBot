...
Description: 
Author: Catop
Date: 2021-06-17 11:11:38
LastEditTime: 2021-06-19 16:19:35
'''
import uuid
import time
import copy
...
def sign(http_method, access_key, secret_key, servlet_path):
    querystring = {"AccessKey": access_key, "Timestamp":"example_time_stamp", "Signature":"", "SignatureMethod":"HmacSHA1","SignatureNonce": str(uuid.uuid4()), "SignatureVersion":"V2.0", "Version":"2016-12-05"}
